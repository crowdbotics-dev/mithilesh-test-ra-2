"""
Django settings for mithilesh_test_ra_2 project.
...
ROOT_URLCONF = 'mithilesh_test_ra_2.urls'
...
WSGI_APPLICATION = 'mithilesh_test_ra_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Mithilesh Test RA Support <support@mithilesh-test-ra-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithilesh_test_ra_2 API",
    "DESCRIPTION": "API documentation for mithilesh_test_ra_2 App",
    "VERSION": "v1",
}
